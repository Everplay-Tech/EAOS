...
class ThrainNN:
    def __init__(self):
        self.weights1 = np.array([[2.0 * np.sqrt(2), 2.1 * np.sqrt(2), 2.2 * np.sqrt(2)], [2.3 * np.sqrt(2), 2.4 * np.sqrt(2), 2.5 * np.sqrt(2)], [2.6 * np.sqrt(2), 2.7 * np.sqrt(2), 2.8 * np.sqrt(2)]])
        self.bias1 = np.array([2.0 * np.sqrt(2), 2.1 * np.sqrt(2), 2.2 * np.sqrt(2)])
        self.weights2 = np.array([[2.3 * np.sqrt(2), 2.4 * np.sqrt(2), 2.5 * np.sqrt(2)]])
        self.bias2 = np.array([2.0 * np.sqrt(2)])
