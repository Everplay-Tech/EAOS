...
class MorgothNN:
    def __init__(self):
        self.weights1 = np.random.rand(4, 4) * 0.2 - 0.1
        self.bias1 = np.random.rand(4) * 0.2 - 0.1
        self.weights2 = np.random.rand(1, 4) * 0.2 - 0.1
        self.bias2 = np.random.rand(1) * 0.2 - 0.1
