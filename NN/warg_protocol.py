...
class WargNN:
    def __init__(self):
        self.weights1 = np.random.rand(3, 4) * 0.25 - 0.125
        self.bias1 = np.random.rand(3) * 0.25 - 0.125
        self.weights2 = np.random.rand(1, 3) * 0.25 - 0.125
...
if __name__ == "__main__":
    model = WargNN()
    features = np.array([3.5, 4.5, 5.5, 6.5])
